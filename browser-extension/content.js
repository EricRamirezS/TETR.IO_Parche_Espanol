...
const achievementTranslations = {
    ...
    objects: {
        ...
        "highest BLITZ score obtained without using Hold": "mayor puntuacion de BLITZ obtenida sin usar HOLD",
        ...
        "highest floor discovered with the \"No Hold\" mod": "piso mas alto descubierto con el mod \"Sin HOLD\"",
        ...
        "highest floor discovered while using the \"No Hold\" and \"Gravity\" mods": "piso mas alto descubierto usando los mods \"Sin HOLD\" y \"Gravedad\"",
        "highest floor discovered while using the \"No Hold\", \"Double Hole Garbage\" and \"Messier Garbage\" mods": "piso mas alto descubierto usando los mods \"Sin HOLD\", \"Basura de doble agujero\" y \"Basura mas desordenada\"",
...
const badgeTranslations = [
    ...
    ["Achieved a World Record on a TETRA CHANNEL leaderboard", "Consiguio un record mundial en una clasificacion de TETRA CHANNEL"],
...
const statusTranslations = {
    ...
    "In Menus": "En el Menu",
    "Spectating QUICK PLAY": ["Espectando una ", "PARTIDA RAPIDA"],
    "Playing QUICK PLAY": ["Jugando una ", "PARTIDA RAPIDA"],
    "In a TETRA LEAGUE queue": ["En una cola de ", "LIGA TETRA"],
    "In TETRA LEAGUE queue": ["En una cola de ", "LIGA TETRA"],
    "In a TETRA LEAGUE game": ["En una partida de ", "LIGA TETRA"],
    "In TETRA LEAGUE game": ["En una partida de ", "LIGA TETRA"],
    "Found a TETRA LEAGUE match": ["Encontraste una partida de ", "LIGA TETRA"],
    "In a public custom room lobby": ["En un lobby publico de ", "sala personalizada"],
    "In a private custom room lobby": ["En un lobby privado de ", "sala personalizada"],
    "Spectating a public custom room game": ["Espectando una partida publica en ", "sala personalizada"],
    "Ending a public custom room game": ["Terminando una partida publica en ", "sala personalizada"],
    "Spectating a private custom room game": ["Espectando una partida privada en ", "sala personalizada"],
    "Ending a private custom room game": ["Terminando una partida privada en ", "sala personalizada"],
    "Playing 40 LINES": ["Jugando ", "40 LINEAS"],
    "Playing BLITZ": ["Jugando ", "BLITZ"],
    "Playing ZEN": ["Jugando ", "ZEN"],
    "Playing a custom game": ["Jugando una ", "PARTIDA PERSONALIZADA"]
};
...
const translations = {
    ...
    "league_chat_container": (e) => {
        const translations = {
            ...
            "joined as spectator":
                "se ha unido como espectador",

            "left the room":
                "se ha ido de la sala"
        };
    ...
    "tetra_myrecords_gamemode": (e) => {
        ...
        const value = translations[e.textContent.trim()];
    ...
    "video_bounciness": (e) => {
        ...
        if (stat) {
            ...
            if (name) text(name, "rebote del tablero");
            if (lower) text(lower, "RIGIDO");
            if (upper) text(upper, "ELASTICO");
    ...
    "video_shakiness": (e) => {
        ...
        if (stat) {
            ...
            if (name) text(name, "sacudida por dano");
            if (lower) text(lower, "RIGIDO");
            if (upper) text(upper, "INQUIETO");
    ...
    "video_gridopacity": (e) => {
        ...
        if (stat) {
            ...
            if (name) text(name, "visibilidad de la cuadricula");
            if (lower) text(lower, "TRANSPARENTE");
            if (upper) text(upper, "OPACA");
    ...
    "video_boardopacity": (e) => {
        ...
        if (stat) {
            ...
            if (name) text(name, "visibilidad del tablero");
            if (lower) text(lower, "TRANSPARENTE");
            if (upper) text(upper, "OPACO");
    ...
    "video_shadowopacity": (e) => {
        ...
        if (stat) {
            ...
            if (name) text(name, "visibilidad de la pieza fantasma");
            if (lower) text(lower, "TRANSPARENTE");
            if (upper) text(upper, "OPACA");
    ...
    "video_zoom": (e) => {
        ...
        if (stat) {
            ...
            if (name) text(name, "zoom del tablero");
            if (lower) text(lower, "LEJOS");
            if (upper) text(upper, "CERCA");
    ...
    "video_particles": (e) => {
        ...
        if (stat) {
            ...
            if (name) text(name, "cantidad de particulas");
            if (lower) text(lower, "POCAS");
            if (upper) text(upper, "MUCHAS");

            attr(stat, "title", "Cantidad de particulas que se muestran.");
        }
    },
    ...
    "video_background": (e) => {
        ...
        if (stat) {
            ...
            if (name) text(name, "visibilidad del fondo");
            if (lower) text(lower, "TRANSPARENTE");
            if (upper) text(upper, "OPACO");
    ...
    "video_bloom": (e) => {
        ...
        if (stat) {
            ...
            if (name) text(name, "potencia del filtro Bloom");
            if (lower) text(lower, "DEBIL");
            if (upper) text(upper, "FUERTE");

            attr(stat, "title", "Indica la potencia del filtro Bloom.");
        }
    },
    ...
    "video_chroma": (e) => {
        ...
        if (stat) {
            ...
            if (name) text(name, "aberracion cromatica");
            if (lower) text(lower, "DEBIL");
            if (upper) text(upper, "FUERTE");
    ...
    "video_flashwave": (e) => {
        ...
        if (stat) {
            ...
            if (name) text(name, "potencia de flashwave");
            if (lower) text(lower, "DEBIL");
            if (upper) text(upper, "FUERTE");
    ...
    "config_account_supporter_support": (e) => text(e, "AGREGAR MESES O REGALAR"),
    ...
    "config_account_supporter_support": (e) => {
        ...
        container.querySelectorAll("h2, h1").forEach(heading => {
            const value = heading.textContent.trim();

            if (translations[value]) {
                text(heading, translations[value]);
            }
        });
    ...
    "replay": (e) => {
        ...
        if (keystone) text(keystone, "REPETICION");
        if (exit) text(exit, "SALIR");
    },
        ...
        e.querySelectorAll(".zenith_deck_info").forEach(info => {
            ...
            if (paragraph) {
                ...
                if (descriptions[value]) {
                    text(paragraph, descriptions[value]);
                }
            }
        });
    },
    ...
    "zenith_results_stats_overview": (e) => {
        ...
        e.querySelectorAll("tr td:first-child").forEach(td => {
            const value = td.textContent.trim();
            const translated = translations[value];
    ...
    "ongoing": (e) => {
        ...
        e.querySelectorAll(".ongoing_header, .ongoing_sub, .ongoing_button").forEach(el => {
            const value = el.textContent.trim();
            const translated = translations[value];
    ...
    "social_status": (e) => {
        ...
        const translations = {
            ...
            "In TETRA LEAGUE game": ["En una partida de ", "LIGA TETRA"],
            "Found a TETRA LEAGUE match": ["Encontraste una partida de ", "LIGA TETRA"],
            "In a public custom room lobby": "En una sala personalizada publica",
            "In a private custom room lobby": "En una sala personalizada privada",
            "Spectating a public custom room game": "Espectando una partida publica personalizada",
            "Ending a public custom room game": "Terminando una partida publica personalizada",
            "Spectating a private custom room game": "Espectando una partida privada personalizada",
            "Ending a private custom room game": "Terminando una partida privada personalizada",
            "Playing 40 LINES": "Jugando 40 LINEAS",
            "Playing BLITZ": "Jugando BLITZ",
            "Playing ZEN": "Jugando ZEN",
            "Playing a custom game": "Jugando una partida personalizada"
    ...
    "social_dm_status": (e) => {
        e.childNodes.forEach(node => {
            ...
            if (
                ...
                if (value === "TETRA LEAGUE") {
                    node.textContent = "LIGA TETRA";
                }
            }
        });
    },
    ...
    "social_notifications_content": (e) => {
        ...
        e.querySelectorAll(".social_notification").forEach(notification => {
            ...
            const description =
                notification.querySelector("p > span");

            if (description) {
                const value = description.textContent.trim();
                const translated =
                    achievementTranslations.descriptions[value];
            ...
            /* TEXTO DINAMICO DE LA NOTIFICACION */
    ...
    "room_switchbracket": (e) => text(e,
        'JUGANDO<div id="swb_addendum">haz clic para cambiar a ESPECTADORES</div>'
    ),
    ...
    "room_players": (e) => {
        ...
        e.querySelectorAll(".host, .observer").forEach(el => {
            const value = el.textContent.trim();
            const translated = translations[value];
        ...
        e.querySelectorAll(".precord, .pstreak").forEach(el => {
            const title = el.getAttribute("title");
...
function custom_game(e) {
    ...
    e.querySelectorAll("h2").forEach(h2 => {
        const translations = {
            "GENERAL": "GENERAL",
        ...
        const translation = translations[h2.textContent.trim()];
...
function custom_objective(e) {
    ...
    e.querySelectorAll("h2").forEach(h2 => {
        if (h2.textContent.trim() === "GENERAL") {
            text(h2, "GENERAL");
        }
    });
...
function custom_meta(e) {
    ...
    e.querySelectorAll("h2").forEach(h2 => {
        ...
        const translation = sectionTranslations[h2.textContent.trim()];
...
function room_room(e) {
    ...
    e.querySelectorAll(".room_config_label").forEach(label => {
        const translation = labels[label.textContent.trim()];
        if (translation) text(label, translation);
    });
    ...
    e.querySelectorAll("[title]").forEach(element => {
        const translation = titles[element.getAttribute("title")];
...
function room_game(e) {
    ...
    e.querySelectorAll("h2").forEach(h2 => {
        if (h2.textContent.trim() === "GENERAL") {
            text(h2, "GENERAL");
        } else if (h2.textContent.trim() === "GRAVITY & MARGIN TIME") {
            text(h2, "GRAVEDAD Y TIEMPO DE MARGEN");
        }
    });
}
...
function translateGlobalShouts() {
    ...
    document.querySelectorAll(".globalshouts .shout").forEach(shout => {
        const value = shout.textContent.trim();
        const translated = translations[value];

        if (translated && translated !== value) {
            shout.textContent = translated;
        }
    });
}
